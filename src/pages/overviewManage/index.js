...
function OverviewManage(){
  ...
  return (
    <>
      <h2>Tổng quan</h2>
      <Row>
        <Col style={{marginBottom:20}} xs={24} sm={8}>
          <Card title="Thông tin Job" variant="borderless" style={{ width: window.innerWidth >576 ?? 300 , height:"100%" }}>
        ...
        <Col style={{marginBottom:20}} xs={24} sm={8}>
          <Card title="Thông tin CV" variant="borderless" style={{ width: window.innerWidth >576 ?? 300 , height:"100%" }}>
        ...
        <Col style={{marginBottom:20}} xs={24} sm={8}>
          <Card title="Thông tin công ty" variant="borderless" style={{ width: window.innerWidth >576 ?? 300 , height:"100%" }}>
